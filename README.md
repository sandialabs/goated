...
After downloading the code, GOATED can be easily installed via `pip install goated` which will install all needed dependencies.  Optional depencies include
